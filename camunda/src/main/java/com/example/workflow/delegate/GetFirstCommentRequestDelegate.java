...
@Component
public class GetFirstCommentRequestDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        CommentRequestEntity commentRequest = commentRequests.get(0);
        execution.setVariable("commentContent", commentRequest.getComment().getContent());
        execution.setVariable("commentRequestId", commentRequest.getId());
    }
}
